...
;// CONCATENATED MODULE: ./src/ui/mixins/header/hamburger-btn/index.ts
var initHamburgerBtn = function () {
    var hamburgerBtn = document.querySelectorAll('.hamburger-btn');
    var mobileMenu = document.querySelector('#mobile-menu');
    hamburgerBtn.forEach(function (btn) {
...
;// CONCATENATED MODULE: ./src/ui/mixins/header/mobile-menu/index.ts
...
;// CONCATENATED MODULE: ./src/ui/mixins/header/index.ts



;// CONCATENATED MODULE: ./src/ui/mixins/index.ts
...
;// CONCATENATED MODULE: ./src/utils/init-slider/init-slider.ts
...
;// CONCATENATED MODULE: ./src/utils/init-slider/index.ts
...
;// CONCATENATED MODULE: ./src/views/pages/blocks/banner/index.ts


initSlider('#banner-cards');

;// CONCATENATED MODULE: ./src/views/pages/blocks/top-sites/index.ts
...
;// CONCATENATED MODULE: ./src/views/pages/blocks/best-slots/index.ts

for (var i = 0; i < 3; i++) {
    initSlider("#slots-cards-".concat(i));
}

;// CONCATENATED MODULE: ./src/views/pages/blocks/payments/index.ts
...
;// CONCATENATED MODULE: ./src/views/pages/blocks/faq/index.ts
var initFaq = function () {
    var wrapper = document.querySelector('.questions');
    if (!wrapper) {
        return;
    }
    var questions = wrapper.querySelectorAll('.question');
    var questionContents = wrapper.querySelectorAll('.question-content');
    var questionMobileContents = wrapper.querySelectorAll('.question-mobile-content');
    var changeStateOfQuestion = function (questionEl) {
        if (!questionEl) {
            return;
        }
        var title = questionEl.querySelector('.question-title');
        var arrowWrapper = questionEl.querySelector('.arrow-wrapper');
        if (arrowWrapper) {
    ...
    questions.forEach(function (question) {
        question.addEventListener('click', function () {
            ...
            var questionContent = questionContents.item(Number(questionNumber));
            var questionMobileContent = question.querySelector('.question-mobile-content');
            ...
            questionContent === null || questionContent === void 0 ? void 0 : questionContent.classList.toggle('hidden');
            questionMobileContents.forEach(function (el) {
                if (el !== questionMobileContent) {
                    el.classList.add('hidden');
                }
            });
            questionMobileContent === null || questionMobileContent === void 0 ? void 0 : questionMobileContent.classList.toggle('hidden');
        });
    });
};
initFaq();

;// CONCATENATED MODULE: ./src/views/pages/blocks/feedback/index.ts
var setRating = function (stars, rating) {
    // const select = document.querySelector('.comment-rating-hidden')
    var classActive = 'text-yellow';
    var classInactive = 'text-grizzly';
...
var executeRating = function () {
    var stars = document.querySelectorAll('.comment-star');
    var currentRating;
...
;// CONCATENATED MODULE: ./src/views/pages/blocks/who-we-are/index.ts
...
;// CONCATENATED MODULE: ./src/views/pages/blocks/interface/index.ts
...
;// CONCATENATED MODULE: ./src/views/pages/blocks/index.ts
...
;// CONCATENATED MODULE: ./src/views/pages/index.ts
...
/******/ })()
;
//# sourceMappingURL=main.0964ea799e2b1c25a736.js.map